...
function HomePage() {
  return (
    <>
      <Head>
        <title>Beer Explorer v01</title>

        <meta
          name="description"
          content="Discover the World of Brews with Beer Explorer v01: Unveiling Intriguing Facts, Tantalizing Tastes, and Exclusive Locations for Your Ultimate Beer Adventure."
        />
      </Head>
        ...
        <Flex p={8} flex={1} align={'center'} justify={'center'}>
          <Stack position="relative" spacing={6} w={'full'} maxW={'lg'}>
            ...
            <Text fontSize={{ base: 'md', lg: 'lg' }} color={'gray.500'}>
              {`Discover the World of Brews with Beer Explorer v01: Unveiling Intriguing Facts, Tantalizing Tastes, and Exclusive Locations for Your Ultimate Beer Adventure.`}
            </Text>
